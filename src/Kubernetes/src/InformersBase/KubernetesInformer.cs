...
using Steeltoe.Kubernetes.InformersBase.FaultTolerance;
using Steeltoe.Kubernetes.InformersBase.Notifications;
using RetryPolicy = Steeltoe.Kubernetes.InformersBase.FaultTolerance.RetryPolicy;
...
namespace Steeltoe.Kubernetes.InformersBase
{
    ...
    public class KubernetesInformer<TResource> : IKubernetesInformer<TResource> where TResource : IKubernetesObject
    {
        ...
        public KubernetesInformer(IKubernetesGenericClient kubernetes, RetryPolicy retryPolicy = null) : this(kubernetes, retryPolicy, () => true)
        {
        }

        public KubernetesInformer(IKubernetesGenericClient kubernetes, RetryPolicy retryPolicy, Func<bool> restartOnCompletion)
        {
