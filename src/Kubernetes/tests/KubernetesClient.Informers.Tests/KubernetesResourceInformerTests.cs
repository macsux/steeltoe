...
using Steeltoe.Kubernetes.Informers.Tests.Utils;
...
namespace Steeltoe.Kubernetes.Informers.Tests
{
    public class KubernetesResourceInformerTests : IDisposable
    {
        private readonly ITestOutputHelper _testOutput;
        private WireMockServer _server;
        private KubernetesGenericClient _kubernetes;
        ...
        public KubernetesResourceInformerTests(ITestOutputHelper testOutput)
        {
            ...
            _kubernetes = new KubernetesGenericClient(new k8s.Kubernetes(new KubernetesClientConfiguration { Host = _server.Urls.First() }));
        }
